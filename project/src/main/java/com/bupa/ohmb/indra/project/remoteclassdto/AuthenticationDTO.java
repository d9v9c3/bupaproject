...
public class AuthenticationDTO {
     ...
     * @param refreshToken
     */
    public AuthenticationDTO(String accessToken, Integer expiresIn, Integer refreshExpiresIn, String refreshToken, String tokenType, Integer notBeforePolicy, String sessionState, String scope) {
        super();
