...
public class UserMemberRemote {
     ...
     * @param memberId
     */
    public UserMemberRemote(Object userId, Integer policyId, Integer memberId, List<Role> roles, String firstName, String lastName, String middleName, String paternalLastName, String maternalLastName, Integer genderId, String gender, String birthDate, Boolean isSharingInfo, Boolean isInsured) {
        super();
        this.userId = userId;
